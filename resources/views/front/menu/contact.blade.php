                ...
                <div class="col-lg-8">
                    <div class="contact-form bg-secondary rounded p-5">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate" method="post" action="">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="age" name="age" placeholder="Your Age" required="required" data-validation-required-message="Please enter your age" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
